...
var _user$project$Animals_Pages_H$HistoryPage = function (a) {
	return {ctor: 'HistoryPage', _0: a};
};
...
var _user$project$Pile_Date$logical = function (date) {
	return A2(_justinmimbs$elm_date_extra$Date_Extra$toFormattedString, 'yyyy-MM-dd', date);
};
var _user$project$Pile_Date$terse = function (date) {
	return A2(_justinmimbs$elm_date_extra$Date_Extra$toFormattedString, 'MMM d', date);
};
var _user$project$Pile_Date$humane = function (date) {
	return A2(_justinmimbs$elm_date_extra$Date_Extra$toFormattedString, 'MMM d, y', date);
};
...
var _user$project$Animals_Types_ModalOverlay$Unimplemented = {ctor: 'Unimplemented'};
var _user$project$Animals_Types_ModalOverlay$AnimalHistoryHelp = {ctor: 'AnimalHistoryHelp'};
var _user$project$Animals_Types_ModalOverlay$AddAnimalsHelp = {ctor: 'AddAnimalsHelp'};
var _user$project$Animals_Types_ModalOverlay$FormHelp = {ctor: 'FormHelp'};
var _user$project$Animals_Types_ModalOverlay$AllPageFilterByHelp = {ctor: 'AllPageFilterByHelp'};
var _user$project$Animals_Types_ModalOverlay$AllPageCalendarHelp = {ctor: 'AllPageCalendarHelp'};
var _user$project$Animals_Types_ModalOverlay$AllPageCalendar = {ctor: 'AllPageCalendar'};
var _user$project$Animals_Types_ModalOverlay$None = {ctor: 'None'};
...
var _user$project$Animals_Msg$SetOverlay = function (a) {
	return {ctor: 'SetOverlay', _0: a};
};
...
var _user$project$Animals_Pages_Navigation$unparseChoice = function (choice) {
	var _p0 = choice;
	if (_p0.ctor === 'HistoryPage') {
		return _elm_lang$core$Maybe$Just(
			A2(
				_elm_lang$core$Basics_ops['++'],
				'/',
...
var _user$project$Animals_Pages_Navigation$parsePath = function (from) {
	var _p1 = A2(_elm_lang$core$String$split, '/', from);
	if ((((((((((_p1.ctor === '::') && (_p1._0 === '')) && (_p1._1.ctor === '::')) && (_p1._1._0 === 'v2')) && (_p1._1._1.ctor === '::')) && (_p1._1._1._0 === 'animals')) && (_p1._1._1._1.ctor === '::')) && (_p1._1._1._1._1.ctor === '::')) && (_p1._1._1._1._1._0 === 'history')) && (_p1._1._1._1._1._1.ctor === '[]')) {
		return _elm_lang$core$Maybe$Just(
			_user$project$Animals_Pages_H$HistoryPage(_p1._1._1._1._0));
	} else {
		return _elm_lang$core$Maybe$Nothing;
	}
};
var _user$project$Animals_Pages_Navigation$convertChoice = function (from) {
	var _p2 = from;
	switch (_p2.ctor) {
		case 'AllPage':
			return _elm_lang$core$Maybe$Just('/v2/animals');
		case 'AddPage':
			return _elm_lang$core$Maybe$Just('/v2/animals/new');
		case 'HelpPage':
			return _elm_lang$core$Maybe$Just('/v2/animals/help');
		default:
			return _elm_lang$core$Maybe$Nothing;
	}
};
var _user$project$Animals_Pages_Navigation$convertPath = function (from) {
	var _p3 = from;
	switch (_p3) {
		case '/v2/animals':
			return _elm_lang$core$Maybe$Just(_user$project$Animals_Pages_H$AllPage);
		case '/v2/animals/new':
			return _elm_lang$core$Maybe$Just(_user$project$Animals_Pages_H$AddPage);
		case '/v2/animals/help':
			return _elm_lang$core$Maybe$Just(_user$project$Animals_Pages_H$HelpPage);
		default:
			return _elm_lang$core$Maybe$Nothing;
	}
};
var _user$project$Animals_Pages_Navigation$defaultPage = _user$project$Animals_Pages_H$AllPage;
var _user$project$Animals_Pages_Navigation$fromLocation = function (location) {
	var path = location.pathname;
	return A2(
		_elm_lang$core$Maybe$withDefault,
		_user$project$Animals_Pages_Navigation$defaultPage,
		A2(
			_elm_community$maybe_extra$Maybe_Extra$orElse,
			_user$project$Animals_Pages_Navigation$parsePath(path),
			_user$project$Animals_Pages_Navigation$convertPath(
				A2(_elm_lang$core$Debug$log, 'path', path))));
};
var _user$project$Animals_Pages_Navigation$defaultPath = '/v2/animals';
var _user$project$Animals_Pages_Navigation$constants = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: _user$project$Animals_Pages_Navigation$defaultPath, _1: _user$project$Animals_Pages_Navigation$defaultPage},
	_1: {ctor: '[]'}
};
var _user$project$Animals_Pages_Navigation$toPageChangeCmd = function (choice) {
	var url = A2(
		_elm_lang$core$Maybe$withDefault,
		_user$project$Animals_Pages_Navigation$defaultPath,
		A2(
			_elm_community$maybe_extra$Maybe_Extra$orElse,
			_user$project$Animals_Pages_Navigation$unparseChoice(choice),
...
var _user$project$Pile_Css_Bulma_Button$rawDisplayButton = F2(
	function (classString, buttonText) {
		return A2(
...
var _user$project$Pile_Css_Bulma_Button$helpTextPrimaryButton = _user$project$Pile_Css_Bulma_Button$rawDisplayButton('button is-primary is-small');
...
var _user$project$Pile_Css_Bulma_Button$smallPrimaryButton = _user$project$Pile_Css_Bulma_Button$rawButton('button is-primary is-small');
...
var _user$project$Pile_Css_Bulma_Button$justForShow = {click: _elm_lang$core$Maybe$Nothing};
...
var _user$project$Pile_Css_Bulma$emsp = '  ';
var _user$project$Pile_Css_Bulma$nbsp = ' ';
var _user$project$Pile_Css_Bulma$zeroWidthSpace = '​';
var _user$project$Pile_Css_Bulma$contentP = function (body) {
	return A2(
		_elm_lang$html$Html$p,
		{
			ctor: '::',
...
var _user$project$Pile_Css_Bulma$simpleSelect = F3(
	function (tagger, options, selectedOption) {
		var textOption = function (_p1) {
			var _p2 = _p1;
			var _p3 = _p2._0;
			return A2(
				_elm_lang$html$Html$option,
				{
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Attributes$selected(
							_elm_lang$core$Native_Utils.eq(_p3, selectedOption)),
						_1: {ctor: '[]'}
					}
				},
				{
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(tagger),
						_1: {ctor: '[]'}
					},
					A2(_elm_lang$core$List$map, textOption, options)),
				_1: {ctor: '[]'}
			});
	});
...
var _user$project$Pile_Css_Bulma$helpTextIcon = function (iconSymbolName) {
	return A2(
		_elm_lang$html$Html$i,
		{
			ctor: '::',
...
var _user$project$Pile_Css_Bulma$plainMessage = function (body) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('columns is-mobile is-centered'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$Pile_Css_Bulma$tab = F2(
	function (selectedPage, _p4) {
		var _p5 = _p4;
		var _p6 = _elm_lang$core$Native_Utils.eq(selectedPage, _p5._0) ? {
			ctor: '_Tuple4',
			_0: 'is-active',
			_1: 'is-disabled',
			_2: {
		...
		var liClass = _p6._0;
		var linkClass = _p6._1;
		var linkStyle = _p6._2;
		var spanClass = _p6._3;
		return A2(
			_elm_lang$html$Html$li,
			{
				ctor: '::',
					...
					_elm_lang$html$Html$a,
					{
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _user$project$Pile_HtmlShorthand$onClickPreventingDefault(_p5._2),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _user$project$Animals_Types_Lenses$form_originalAnimal = A2(
	_user$project$Pile_UpdatingLens$lens,
	function (_) {
		return _.originalAnimal;
	},
	F2(
		function (p, w) {
			return _elm_lang$core$Native_Utils.update(
...
var _user$project$Animals_OutsideWorld_Encode$separate = function (properties) {
	var step = F3(
		function (key, sumValue, building) {
			var _p0 = sumValue;
			switch (_p0.ctor) {
				case 'AsInt':
					return _elm_lang$core$Native_Utils.update(
	...
	var empty = {ints: _elm_lang$core$Dict$empty, strings: _elm_lang$core$Dict$empty, bools: _elm_lang$core$Dict$empty};
	return A3(_elm_lang$core$Dict$foldl, step, empty, properties);
};
var _user$project$Animals_OutsideWorld_Encode$properties = function (valueEncoder) {
	var encodeKV = function (_p1) {
		var _p2 = _p1;
		return {
			ctor: '_Tuple2',
			_0: _p2._0,
			_1: _elm_lang$core$Json_Encode$list(
				{
					ctor: '::',
					_0: valueEncoder(_p2._1._0),
					_1: {
						ctor: '::',
						_0: _elm_lang$core$Json_Encode$string(_p2._1._1),
						_1: {ctor: '[]'}
					}
				})
		};
...
var _user$project$Animals_OutsideWorld_Encode$addingMetadata = F2(
	function (holder, v) {
		var audit_date = _elm_lang$core$Json_Encode$string(
			_justinmimbs$elm_date_extra$Date_Extra$toIsoString(
				_user$project$Pile_DateHolder$todayDate(holder)));
		var effective_date = _elm_lang$core$Json_Encode$string(
			_justinmimbs$elm_date_extra$Date_Extra$toIsoString(
				_user$project$Pile_DateHolder$convertToDate(holder)));
		var metadata = _elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'effective_date', _1: effective_date},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'audit_date', _1: audit_date},
					_1: {ctor: '[]'}
				}
			});
		return _elm_lang$core$Json_Encode$object(
			{
				...
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'metadata', _1: metadata},
					_1: {ctor: '[]'}
				}
			});
	});
var _user$project$Animals_OutsideWorld_Encode$animal = function (animal) {
	var outProps = _user$project$Animals_OutsideWorld_Encode$separate(animal.properties);
	var creationDateString = _justinmimbs$elm_date_extra$Date_Extra$toIsoString(animal.creationDate);
	var intId = A2(
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'id',
				_1: _elm_lang$core$Json_Encode$int(intId)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'version',
					_1: _elm_lang$core$Json_Encode$int(animal.version)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'name',
						_1: _elm_lang$core$Json_Encode$string(animal.name)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'species',
							_1: _elm_lang$core$Json_Encode$string(animal.species)
						},
						_1: {
							ctor: '::',
							_0: {
								...
								_0: 'tags',
								_1: _elm_lang$core$Json_Encode$list(
									A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, animal.tags))
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'bool_properties',
									_1: A2(_user$project$Animals_OutsideWorld_Encode$properties, _elm_lang$core$Json_Encode$bool, outProps.bools)
								},
								_1: {
									ctor: '::',
									_0: {
										ctor: '_Tuple2',
										_0: 'int_properties',
										_1: A2(_user$project$Animals_OutsideWorld_Encode$properties, _elm_lang$core$Json_Encode$int, outProps.ints)
									},
									_1: {
										ctor: '::',
										_0: {
											...
											_1: A2(_user$project$Animals_OutsideWorld_Encode$properties, _elm_lang$core$Json_Encode$string, outProps.strings)
										},
										_1: {
											ctor: '::',
											_0: {
												ctor: '_Tuple2',
												_0: 'creation_date',
												_1: _elm_lang$core$Json_Encode$string(creationDateString)
											},
											_1: {ctor: '[]'}
										}
									}
...
var _user$project$Animals_OutsideWorld_Encode$SeparatedProperties = F3(
	function (a, b, c) {
		return {ints: a, strings: b, bools: c};
	});

var _user$project$Animals_OutsideWorld_Decode$decodeProperties = function (valueDecoder) {
...
var _user$project$Animals_OutsideWorld_Decode$fromIsoString = function (s) {
	var _p0 = _justinmimbs$elm_date_extra$Date_Extra$fromIsoString(s);
	if (_p0.ctor === 'Just') {
		return _p0._0;
	} else {
		return A3(_justinmimbs$elm_date_extra$Date_Extra$fromCalendarDate, 2000, _elm_lang$core$Date$Jan, 1);
...
var _user$project$Animals_OutsideWorld_Decode$animalInputFormat_to_Animal = function (incoming) {
	var dictify = F2(
	...
	return {
		...
		creationDate: _user$project$Animals_OutsideWorld_Decode$fromIsoString(incoming.creation_date)
	};
};
var _user$project$Animals_OutsideWorld_Decode$historyEntryInputFormat_to_Entry = function (incoming) {
	return {
		nameChange: incoming.name_change,
		newTags: incoming.new_tags,
		deletedTags: incoming.deleted_tags,
		effectiveDate: _user$project$Animals_OutsideWorld_Decode$fromIsoString(incoming.effective_date),
		audit: {
			author: incoming.audit_author,
			date: _user$project$Animals_OutsideWorld_Decode$fromIsoString(incoming.audit_date)
		}
	};
};
var _user$project$Animals_OutsideWorld_Decode$creationResponse = function () {
	var from_transferFormat = function (_p2) {
		var _p3 = _p2;
		return A2(
...
var _user$project$Animals_OutsideWorld_Decode$saveResponse = function () {
...
var _user$project$Animals_OutsideWorld_Decode$withinData = _elm_lang$core$Json_Decode$at(
	{
		ctor: '::',
		_0: 'data',
		_1: {ctor: '[]'}
	});
var _user$project$Animals_OutsideWorld_Decode$HistoryEntryInputFormat = F6(
	function (a, b, c, d, e, f) {
		return {name_change: a, new_tags: b, deleted_tags: c, effective_date: d, audit_date: e, audit_author: f};
	});
var _user$project$Animals_OutsideWorld_Decode$json_to_HistoryEntryInputFormat = A3(
			...
			A3(
				...
				A3(
					...
					A3(
						...
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Animals_OutsideWorld_Decode$HistoryEntryInputFormat)))))));
var _user$project$Animals_OutsideWorld_Decode$historyEntry = A2(_elm_lang$core$Json_Decode$map, _user$project$Animals_OutsideWorld_Decode$historyEntryInputFormat_to_Entry, _user$project$Animals_OutsideWorld_Decode$json_to_HistoryEntryInputFormat);
var _user$project$Animals_OutsideWorld_Decode$history = _elm_lang$core$Json_Decode$list(_user$project$Animals_OutsideWorld_Decode$historyEntry);
var _user$project$Animals_OutsideWorld_Decode$AnimalInputFormat = F9(
...
var _user$project$Animals_OutsideWorld_Decode$json_to_AnimalInputFormat = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'creation_date',
	_elm_lang$core$Json_Decode$string,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'string_properties',
		_user$project$Animals_OutsideWorld_Decode$decodeProperties(_elm_lang$core$Json_Decode$string),
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'bool_properties',
			_user$project$Animals_OutsideWorld_Decode$decodeProperties(_elm_lang$core$Json_Decode$bool),
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'int_properties',
				_user$project$Animals_OutsideWorld_Decode$decodeProperties(_elm_lang$core$Json_Decode$int),
				A3(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
					'tags',
					_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string),
						...
						A3(
							...
							A3(
								...
								A3(
									...
									'id',
									_elm_lang$core$Json_Decode$int,
									_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Animals_OutsideWorld_Decode$AnimalInputFormat))))))))));
var _user$project$Animals_OutsideWorld_Decode$animal = A2(_elm_lang$core$Json_Decode$map, _user$project$Animals_OutsideWorld_Decode$animalInputFormat_to_Animal, _user$project$Animals_OutsideWorld_Decode$json_to_AnimalInputFormat);
var _user$project$Animals_OutsideWorld_Decode$animals = _elm_lang$core$Json_Decode$list(_user$project$Animals_OutsideWorld_Decode$animal);
...
var _user$project$Animals_OutsideWorld_Cmd$animalBody = F2(
	function (effectiveDate, animal) {
		return _elm_lang$http$Http$jsonBody(
			A2(
				_user$project$Animals_OutsideWorld_Encode$addingMetadata,
				effectiveDate,
				_user$project$Animals_OutsideWorld_Encode$animal(animal)));
	});
var _user$project$Animals_OutsideWorld_Cmd$animalHistory = F2(
	function (id, name) {
		...
		var request = A2(
			...
			url,
			_user$project$Animals_OutsideWorld_Decode$withinData(_user$project$Animals_OutsideWorld_Decode$history));
		return A2(
...
var _user$project$Animals_OutsideWorld_Cmd$createAnimal = F2(
	function (effectiveDate, animal) {
		var body = A2(_user$project$Animals_OutsideWorld_Cmd$animalBody, effectiveDate, animal);
		...
		var request = A3(
			...
			url,
			body,
			_user$project$Animals_OutsideWorld_Decode$withinData(_user$project$Animals_OutsideWorld_Decode$creationResponse));
		return A2(
			_elm_lang$http$Http$send,
...
var _user$project$Animals_OutsideWorld_Cmd$saveAnimal = F2(
	function (effectiveDate, animal) {
		...
		var request = A3(
			...
			url,
			body,
			_user$project$Animals_OutsideWorld_Decode$withinData(_user$project$Animals_OutsideWorld_Decode$saveResponse));
		return A2(
			_elm_lang$http$Http$send,
...
var _user$project$Animals_OutsideWorld_Cmd$fetchAnimals = function (date) {
	...
	var compactDate = _user$project$Pile_Date$logical(date);
	var url = A2(_elm_lang$core$Basics_ops['++'], '/api/v2animals?date=', compactDate);
	var request = A2(
		_elm_lang$http$Http$get,
		url,
		_user$project$Animals_OutsideWorld_Decode$withinData(_user$project$Animals_OutsideWorld_Decode$animals));
	return A2(
		_elm_lang$http$Http$send,
		A2(
			_user$project$Animals_OutsideWorld_Cmd$handleHtmlResult,
...
var _user$project$Animals_Model$model_historyOrder = A2(
	_user$project$Pile_UpdatingLens$lens,
	function (_) {
		return _.historyOrder;
	},
	F2(
		function (p, w) {
			return _elm_lang$core$Native_Utils.update(
...
var _user$project$Animals_Model$model_historyPages = A2(
	_user$project$Pile_UpdatingLens$lens,
	function (_) {
		return _.historyPages;
	},
	F2(
		function (p, w) {
			return _elm_lang$core$Native_Utils.update(
...
var _user$project$Animals_Model$model_overlay = A2(
	_user$project$Pile_UpdatingLens$lens,
	function (_) {
		return _.overlay;
	},
...
var _user$project$Animals_Model$forgetHistoryPage = F2(
	function (id, model) {
		return A2(
			_user$project$Animals_Model$model_historyOrder.update,
			_elm_community$list_extra$List_Extra$remove(id),
			A2(
				_user$project$Animals_Model$model_historyPages.update,
				_elm_lang$core$Dict$remove(id),
				model));
	});
var _user$project$Animals_Model$placeHistoryInOrder = function (id) {
	return _user$project$Animals_Model$model_historyOrder.update(
		function (order) {
			return {ctor: '::', _0: id, _1: order};
		});
};
var _user$project$Animals_Model$upsertHistoryPage = F2(
	function (id, history) {
		return _user$project$Animals_Model$model_historyPages.update(
			A2(_elm_lang$core$Dict$insert, id, history));
	});
...
var _user$project$Animals_Model$init = F2(
	function (flags, location) {
		var model = {
			...
			overlay: _user$project$Animals_Types_ModalOverlay$None,
			...
			animalsEverAdded: 0,
			historyPages: _elm_lang$core$Dict$empty,
			historyOrder: {ctor: '[]'}
		};
											...
											return function (l) {
												return function (m) {
													return function (n) {
														return function (o) {
															return function (p) {
																return {page: a, pageFlash: b, overlay: c, csrfToken: d, displayables: e, allPageAnimals: f, nameFilter: g, tagFilter: h, speciesFilter: i, effectiveDate: j, addPageAnimals: k, speciesToAdd: l, numberToAdd: m, animalsEverAdded: n, historyPages: o, historyOrder: p};
															};
														};
													};
												};
...
var _user$project$Pile_UpdateHelpers$addCmd = F2(
	function (cmd, model) {
	...
	function (op, model) {
		...
		return _user$project$Pile_UpdateHelpers$noCmd(
			A2(
				...
				A2(_user$project$Animals_View_PageFlash$HttpErrorFlash, _p0._0, _p0._1),
				model));
	});

var _user$project$Animals_Logic_AnimalOp$update = F3(
	function (op, animal, model) {
		var _p0 = op;
		switch (_p0.ctor) {
			case 'RemoveAnimalFlash':
				return _user$project$Pile_UpdateHelpers$noCmd(
					A2(_user$project$Animals_Model$upsertAnimal, animal, model));
			case 'SwitchToReadOnly':
				var newAnimal = A2(_user$project$Animals_Types_Lenses$animal_displayFormat.set, _p0._0, animal);
				return _user$project$Pile_UpdateHelpers$noCmd(
					A2(_user$project$Animals_Model$upsertAnimal, newAnimal, model));
			default:
				var form = A2(_user$project$Animals_Types_Conversions$animalToForm, model.effectiveDate, animal);
				return _user$project$Pile_UpdateHelpers$noCmd(
					A2(_user$project$Animals_Model$upsertCheckedForm, form, model));
		}
	});

var _user$project$Animals_Logic_Validation$validator = F4(
	function (errorMessage, lens, pred, form) {
		var formValue = lens.get(form);
		var _p0 = pred(formValue.value);
		if (_p0 === true) {
			return A2(
				_user$project$Animals_Types_Lenses$form_status.set,
				_user$project$Pile_Css_H$SomeBad,
				A2(
					lens.set,
					A2(_user$project$Pile_Css_H$invalidate, errorMessage, formValue),
					form));
		} else {
			return form;
		}
	});
var _user$project$Animals_Logic_Validation$validateName = F2(
	function (nameClashes, form) {
		return A4(
			_user$project$Animals_Logic_Validation$validator,
			'There is already an animal with that name!',
			_user$project$Animals_Types_Lenses$form_name,
			A2(_elm_lang$core$Basics$flip, _user$project$Pile_Namelike$isMember, nameClashes),
			A4(_user$project$Animals_Logic_Validation$validator, 'The animal has to have a name!', _user$project$Animals_Types_Lenses$form_name, _user$project$Pile_Namelike$isBlank, form));
	});
var _user$project$Animals_Logic_Validation$forceValid = function (form) {
	return _elm_lang$core$Native_Utils.update(
		form,
		{
			status: _user$project$Pile_Css_H$AllGood,
			name: _user$project$Pile_Css_H$freshValue(form.name.value)
		});
};
var _user$project$Animals_Logic_Validation$validate = function (context) {
	return function (_p1) {
		return A2(
			_user$project$Animals_Logic_Validation$validateName,
			context.disallowedNames,
			_user$project$Animals_Logic_Validation$forceValid(_p1));
	};
};
var _user$project$Animals_Logic_Validation$animalNames = function (displayables) {
	return A2(
		_elm_lang$core$List$filter,
		_user$project$Pile_Namelike$isPresent,
		A2(
			_elm_lang$core$List$map,
			_user$project$Animals_Types_Lenses$displayed_name.get,
...
var _user$project$Animals_Logic_FormOp$withSavedForm = F2(
	function (form, model) {
		return {
			ctor: '_Tuple2',
			_0: A2(
				_user$project$Animals_Model$upsertCheckedForm,
				A2(_user$project$Animals_Types_Lenses$form_status.set, _user$project$Pile_Css_H$BeingSaved, form),
				model),
			_1: _user$project$Animals_Types_Conversions$formToAnimal(form)
		};
	});
var _user$project$Animals_Logic_FormOp$update = F3(
	function (op, form, model) {
		var _p0 = op;
		switch (_p0.ctor) {
			case 'RemoveFormFlash':
				return _user$project$Pile_UpdateHelpers$noCmd(
					A2(_user$project$Animals_Model$upsertCheckedForm, form, model));
			case 'CancelEdits':
				var original = form.originalAnimal;
				var _p1 = original;
				if (_p1.ctor === 'Nothing') {
					return _user$project$Pile_UpdateHelpers$noCmd(model);
				} else {
					return _user$project$Pile_UpdateHelpers$noCmd(
						A2(_user$project$Animals_Model$upsertAnimal, _p1._0, model));
				}
			case 'CancelCreation':
				return _user$project$Pile_UpdateHelpers$noCmd(
					A3(
						_user$project$Animals_Model$deleteFromPage,
						_user$project$Animals_Model$model_addPageAnimals,
						form.id,
						A2(_user$project$Animals_Model$deleteDisplayedById, form.id, model)));
			case 'StartSavingEdits':
				var updatedAnimal = _user$project$Animals_Types_Conversions$formToAnimal(form);
				return A2(
					_user$project$Pile_UpdateHelpers$addCmd,
					A2(_user$project$Animals_OutsideWorld_Cmd$saveAnimal, form.effectiveDate, updatedAnimal),
					A2(
						_user$project$Animals_Model$upsertCheckedForm,
						A2(_user$project$Animals_Types_Lenses$form_status.set, _user$project$Pile_Css_H$BeingSaved, form),
						model));
			case 'StartCreating':
				var newAnimal = _user$project$Animals_Types_Conversions$formToAnimal(form);
				return A2(
					_user$project$Pile_UpdateHelpers$addCmd,
					A2(_user$project$Animals_OutsideWorld_Cmd$createAnimal, form.effectiveDate, newAnimal),
					A2(
						_user$project$Animals_Model$upsertCheckedForm,
						A2(_user$project$Animals_Types_Lenses$form_status.set, _user$project$Pile_Css_H$BeingSaved, form),
						model));
			...
			case 'TentativeTagUpdate':
				var newForm = A2(_user$project$Animals_Types_Lenses$form_tentativeTag.set, _p0._0, form);
				return _user$project$Pile_UpdateHelpers$noCmd(
					A2(_user$project$Animals_Model$upsertCheckedForm, newForm, model));
			case 'CreateNewTag':
				var newForm = A2(
					_user$project$Animals_Types_Lenses$form_tentativeTag.set,
					'',
					A2(
						_user$project$Animals_Types_Lenses$form_tags.update,
			...
			case 'DeleteTag':
				var newForm = A2(
					_user$project$Animals_Types_Lenses$form_tags.update,
					_elm_community$list_extra$List_Extra$remove(_p0._0),
					form);
				return _user$project$Pile_UpdateHelpers$noCmd(
					A2(_user$project$Animals_Model$upsertCheckedForm, newForm, model));
			...
			case 'SelectFormDate':
				var newForm = A2(
					_user$project$Animals_Types_Lenses$form_effectiveDate_chosen.set,
					_user$project$Pile_DateHolder$At(_p0._0),
					form);
				return _user$project$Pile_UpdateHelpers$noCmd(
					A2(_user$project$Animals_Model$upsertCheckedForm, newForm, model));
			case 'NoticeSaveResults':
				var displayed = _user$project$Animals_Types_Conversions$finishedFormToDisplayed(form);
				return _user$project$Pile_UpdateHelpers$noCmd(
					A2(_user$project$Animals_Model$upsertDisplayed, displayed, model));
			default:
				var _p5 = _p0._0;
				var displayed = _user$project$Animals_Types_Conversions$finishedFormToDisplayed(
					A2(_user$project$Animals_Types_Lenses$form_id.set, _p5, form));
				var putOnAllPage = function (_p2) {
					return A2(
						_user$project$Animals_Model$model_allPageAnimals.update,
						_elm_lang$core$Set$insert(_p5),
						A2(_user$project$Animals_Model$upsertDisplayed, displayed, _p2));
				};
				var idDuringCreation = form.id;
				var removeFromAddPage = function (_p3) {
					return A2(
						_user$project$Animals_Model$model_addPageAnimals.update,
						_elm_lang$core$Set$remove(idDuringCreation),
						A2(_user$project$Animals_Model$deleteDisplayedById, idDuringCreation, _p3));
				};
				var _p4 = A2(_user$project$Pile_DateHolder$firstAfterSecond, form.effectiveDate, model.effectiveDate);
				if (_p4 === true) {
					return _user$project$Pile_UpdateHelpers$noCmd(
						A2(
							_user$project$Animals_Model$model_pageFlash.set,
							_user$project$Animals_View_PageFlash$SavedAnimalWillNotAppearFlash,
							removeFromAddPage(model)));
				} else {
					return _user$project$Pile_UpdateHelpers$noCmd(
						A2(
							_user$project$Animals_Model$model_pageFlash.set,
							_user$project$Animals_View_PageFlash$SavedAnimalFlash,
							putOnAllPage(
								removeFromAddPage(model))));
				}
		}
	});
var _user$project$Animals_Logic_FormOp$forwardToForm = F3(
	function (id, op, model) {
		var _p6 = A2(
			...
			A2(_user$project$Animals_Model$getDisplayed, id, model));
		if (_p6.ctor === 'Nothing') {
			return _user$project$Pile_UpdateHelpers$noCmd(model);
		} else {
			if (_p6._0.ctor === 'Viewable') {
				return _user$project$Pile_UpdateHelpers$noCmd(model);
			} else {
				return A3(_user$project$Animals_Logic_FormOp$update, op, _p6._0._0, model);
			}
		}
	});
...
var _user$project$Animals_Logic_AddPageOp$adjustCountString = F2(
	function (string, model) {
		var formValue = function () {
			var _p0 = _user$project$Pile_ConstrainedStrings$classify_strictlyPositive(string);
			switch (_p0.ctor) {
				case 'Blank':
					return _user$project$Pile_Css_H$silentlyInvalid(string);
				case 'DoesNotParse':
					return model.numberToAdd;
				case 'ParsedButWrong':
					return _user$project$Pile_Css_H$silentlyInvalid(string);
				default:
					return _user$project$Pile_Css_H$freshValue(string);
			}
		}();
		return A2(_user$project$Animals_Model$model_numberToAdd.set, formValue, model);
	});
var _user$project$Animals_Logic_AddPageOp$addFormsWithIds = F3(
	function (count, formMaker, model) {
		var _p1 = A2(_user$project$Animals_Model$freshIds, count, model);
		var ids = _p1._0;
		var newModel = _p1._1;
		var displayables = A2(
			_elm_lang$core$List$map,
			_user$project$Animals_Types_Conversions$checkedFormToDisplayed,
			A2(_elm_lang$core$List$map, formMaker, ids));
		return A2(
			_user$project$Animals_Model$model_addPageAnimals.update,
			_user$project$Animals_Types_DisplayedCollections$addReferences(displayables),
			A2(
				_user$project$Animals_Model$model_displayables.update,
				_user$project$Animals_Types_DisplayedCollections$add(displayables),
				newModel));
	});
var _user$project$Animals_Logic_AddPageOp$update = F2(
	function (op, model) {
		var _p2 = op;
		switch (_p2.ctor) {
			case 'SetAddedSpecies':
				return _user$project$Pile_UpdateHelpers$noCmd(
					A2(_user$project$Animals_Model$model_speciesToAdd.set, _p2._0, model));
			case 'UpdateAddedCount':
				return _user$project$Pile_UpdateHelpers$noCmd(
					A2(_user$project$Animals_Logic_AddPageOp$adjustCountString, _p2._0, model));
			default:
				var today = _user$project$Pile_DateHolder$chooseToday(model.effectiveDate);
				return _user$project$Pile_UpdateHelpers$noCmd(
					A3(
						_user$project$Animals_Logic_AddPageOp$addFormsWithIds,
						_p2._0,
						A2(_user$project$Animals_Types_Form$fresh, today, _p2._1),
						model));
		}
	});

var _user$project$Animals_Logic_DisplayedOp$withGatherFlash = F2(
	function (displayed, string) {
		var harmlessValue = 1;
		var setWith = F2(
			function (valueMaker, correspondingCount) {
				return A2(
					_user$project$Animals_Types_Lenses$displayed_flash.set,
					A3(
						_user$project$Animals_View_AnimalFlash$CopyInfoNeeded,
						_user$project$Animals_Types_Lenses$displayed_id.get(displayed),
						valueMaker(string),
						correspondingCount),
					displayed);
		...
		switch (_p0.ctor) {
			case 'Blank':
				return A2(setWith, _user$project$Pile_Css_H$silentlyInvalid, harmlessValue);
			case 'DoesNotParse':
				return displayed;
			case 'ParsedButWrong':
				return A2(setWith, _user$project$Pile_Css_H$silentlyInvalid, harmlessValue);
			default:
				return A2(setWith, _user$project$Pile_Css_H$freshValue, _p0._0);
		}
	});
var _user$project$Animals_Logic_DisplayedOp$addAnimalForms = F3(
	function (source, count, model) {
		var sourceForm = A2(
			_user$project$Animals_Types_Lenses$form_intendedVersion.set,
			1,
			A2(
				_user$project$Animals_Types_Lenses$form_originalAnimal.set,
				_elm_lang$core$Maybe$Nothing,
				A2(
					_user$project$Animals_Types_Lenses$form_name.set,
					_user$project$Animals_Types_Form$emptyNameWithNotice,
					A2(_user$project$Animals_Types_Conversions$displayedToForm, model.effectiveDate, source))));
		return A3(
			_user$project$Animals_Logic_AddPageOp$addFormsWithIds,
			count,
			A2(_elm_lang$core$Basics$flip, _user$project$Animals_Types_Lenses$form_id.set, sourceForm),
			model);
	});
var _user$project$Animals_Logic_DisplayedOp$update = F3(
	function (op, displayed, model) {
		var _p1 = op;
		switch (_p1.ctor) {
			case 'BeginGatheringCopyInfo':
				return _user$project$Pile_UpdateHelpers$noCmd(
					A2(
						_user$project$Animals_Model$upsertDisplayed,
						A2(_user$project$Animals_Logic_DisplayedOp$withGatherFlash, displayed, '1'),
						model));
			case 'UpdateCopyCount':
				return _user$project$Pile_UpdateHelpers$noCmd(
					A2(
						_user$project$Animals_Model$upsertDisplayed,
						A2(_user$project$Animals_Logic_DisplayedOp$withGatherFlash, displayed, _p1._0),
						model));
			default:
				return A2(
					_user$project$Pile_UpdateHelpers$addCmd,
					_user$project$Animals_Pages_Navigation$toPageChangeCmd(_user$project$Animals_Pages_H$AddPage),
					A2(
						_user$project$Animals_Model$upsertDisplayed,
						A2(_user$project$Animals_Types_Lenses$displayed_flash.set, _user$project$Animals_View_AnimalFlash$NoFlash, displayed),
						A3(_user$project$Animals_Logic_DisplayedOp$addAnimalForms, displayed, _p1._0, model)));
		}
	});
var _user$project$Animals_Logic_DisplayedOp$forwardToDisplayed = F3(
	function (id, op, model) {
		var _p2 = A2(_user$project$Animals_Model$getDisplayed, id, model);
		if (_p2.ctor === 'Nothing') {
			return _user$project$Pile_UpdateHelpers$noCmd(model);
		} else {
			return A3(_user$project$Animals_Logic_DisplayedOp$update, op, _p2._0, model);
		}
	});

var _user$project$Animals_Logic_AllPageOp$erasePage = function (model) {
	return A2(
		_user$project$Animals_Model$model_allPageAnimals.set,
		_elm_lang$core$Set$empty,
		A2(
			_user$project$Animals_Model$model_displayables.update,
			_user$project$Animals_Types_DisplayedCollections$removeMembers(model.allPageAnimals),
			model));
};
var _user$project$Animals_Logic_AllPageOp$addToPage = F2(
	function (animals, model) {
		var newDisplayables = A2(_elm_lang$core$List$map, _user$project$Animals_Types_Conversions$animalToDisplayed, animals);
		var newIds = _user$project$Animals_Types_DisplayedCollections$idSet(newDisplayables);
		return A2(
			_user$project$Animals_Model$model_allPageAnimals.update,
			_elm_lang$core$Set$union(newIds),
			A2(
				_user$project$Animals_Model$model_displayables.update,
				_user$project$Animals_Types_DisplayedCollections$add(newDisplayables),
				model));
	});
var _user$project$Animals_Logic_AllPageOp$update = F2(
	function (op, model) {
		var _p0 = op;
		switch (_p0.ctor) {
			case 'OpenDatePicker':
				...
				return _user$project$Pile_UpdateHelpers$noCmd(
					A2(
						...
						A2(_user$project$Animals_Model$model_overlay.set, _user$project$Animals_Types_ModalOverlay$AllPageCalendar, model)));
			case 'CalendarClick':
				return _user$project$Pile_UpdateHelpers$noCmd(
					A2(
						_user$project$Animals_Model$model_datePickerState.set,
				...
				return A2(
					...
					_user$project$Animals_Logic_AllPageOp$erasePage(
						A2(
							...
							newEffectiveDate,
							A2(_user$project$Animals_Model$model_overlay.set, _user$project$Animals_Types_ModalOverlay$None, model))));
			case 'DiscardCalendarDate':
				return _user$project$Pile_UpdateHelpers$noCmd(
					A2(
						_user$project$Animals_Model$model_datePickerState.set,
						_user$project$Pile_DateHolder$PickerClosed,
						A2(_user$project$Animals_Model$model_overlay.set, _user$project$Animals_Types_ModalOverlay$None, model)));
			case 'SetAnimals':
				return _user$project$Pile_UpdateHelpers$noCmd(
					A2(
						_user$project$Animals_Logic_AllPageOp$addToPage,
						_p0._0,
						_user$project$Animals_Logic_AllPageOp$erasePage(model)));
			case 'SetNameFilter':
				return _user$project$Pile_UpdateHelpers$noCmd(
					A2(_user$project$Animals_Model$model_nameFilter.set, _p0._0, model));
			case 'SetTagFilter':
				return _user$project$Pile_UpdateHelpers$noCmd(
					A2(_user$project$Animals_Model$model_tagFilter.set, _p0._0, model));
			default:
				return _user$project$Pile_UpdateHelpers$noCmd(
...
var _user$project$Animals_Logic_HistoryPageOp$nextPage = F2(
	function (id, list) {
		var _p0 = A2(_elm_community$list_extra$List_Extra$elemIndex, id, list);
		if (_p0.ctor === 'Nothing') {
			return _user$project$Animals_Pages_H$AllPage;
		} else {
			var _p2 = _p0._0;
			var _p1 = {
				ctor: '_Tuple2',
				_0: A2(_elm_community$list_extra$List_Extra$getAt, _p2 - 1, list),
				_1: A2(_elm_community$list_extra$List_Extra$getAt, _p2 + 1, list)
			};
			_v1_2:
			do {
				if (_p1.ctor === '_Tuple2') {
					if (_p1._1.ctor === 'Just') {
						return _user$project$Animals_Pages_H$HistoryPage(_p1._1._0);
					} else {
						if (_p1._0.ctor === 'Just') {
							return _user$project$Animals_Pages_H$HistoryPage(_p1._0._0);
						} else {
							break _v1_2;
						}
					}
...
var _user$project$Animals_Logic_HistoryPageOp$update = F3(
	function (op, history, model) {
		...
		if (_p3.ctor === 'SetHistory') {
			...
			var next = A2(_user$project$Animals_Logic_HistoryPageOp$nextPage, history.id, model.historyOrder);
			return A2(
				_user$project$Pile_UpdateHelpers$addCmd,
				_user$project$Animals_Pages_Navigation$toPageChangeCmd(next),
				A2(_user$project$Animals_Model$forgetHistoryPage, history.id, model));
		}
	});
var _user$project$Animals_Logic_HistoryPageOp$forwardToPageOp = F3(
	function (id, op, model) {
		var _p4 = A2(_elm_lang$core$Dict$get, id, model.historyPages);
		if (_p4.ctor === 'Nothing') {
			return _user$project$Pile_UpdateHelpers$noCmd(model);
		} else {
			return A3(_user$project$Animals_Logic_HistoryPageOp$update, op, _p4._0, model);
		}
	});
...
var _user$project$Animals_Pages_Update$update = F2(
	function (op, model) {
		...
		if (_p0.ctor === 'NoticeChange') {
			...
			return A2(
				_user$project$Pile_UpdateHelpers$addCmd,
				_user$project$Animals_Pages_Navigation$toPageChangeCmd(_p0._0),
				model);
		}
	});
...
var _user$project$Animals_Update$updateWithClearedPageFlash = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'WithForm':
				return A3(_user$project$Animals_Logic_FormOp$update, _p0._1, _p0._0, model);
			case 'WithDisplayedId':
				return A3(_user$project$Animals_Logic_DisplayedOp$forwardToDisplayed, _p0._0, _p0._1, model);
			case 'Navigate':
				return A2(_user$project$Animals_Pages_Update$update, _p0._0, model);
			case 'Incoming':
				return A2(_user$project$Animals_OutsideWorld_Update$update, _p0._0, model);
			case 'SetToday':
				var _p1 = _p0._0;
				return A2(
					_user$project$Pile_UpdateHelpers$addCmd,
					_user$project$Animals_OutsideWorld_Cmd$fetchAnimals(_p1),
					A2(_user$project$Animals_Model$model_today.set, _p1, model));
			case 'AnimalGotSaved':
				return A3(_user$project$Animals_Logic_FormOp$forwardToForm, _p0._0._0, _user$project$Animals_Msg$NoticeSaveResults, model);
			case 'AnimalGotCreated':
				return A3(
					_user$project$Animals_Logic_FormOp$forwardToForm,
					_p0._0._0,
					_user$project$Animals_Msg$NoticeCreationResults(_p0._0._1),
					model);
			case 'NewHistoryPage':
				var _p3 = _p0._0;
				var id = _p3.id;
				var upsert = A2(
					_user$project$Animals_Model$upsertHistoryPage,
					id,
			...
			case 'SetOverlay':
				return _user$project$Pile_UpdateHelpers$noCmd(
					A2(_user$project$Animals_Model$model_overlay.set, _p0._0, model));
			default:
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
...
var _user$project$Animals_Update$update = F2(
	function (msg, model) {
		return A2(
			_user$project$Animals_Update$updateWithClearedPageFlash,
			msg,
			A2(_user$project$Animals_Model$model_pageFlash.set, _user$project$Animals_View_PageFlash$NoFlash, model));
	});
...
var _user$project$Animals_View_Icons$editHelp = function (iconType) {
	return A3(
		...
		'fa-question-circle',
		'Help on editing',
		_user$project$Animals_Msg$SetOverlay(_user$project$Animals_Types_ModalOverlay$FormHelp));
};
...
var _user$project$Animals_View_Animal$creationDate = function (animal) {
	return _elm_lang$html$Html$text(
		A2(
			_elm_lang$core$Basics_ops['++'],
			'Created on ',
			_user$project$Pile_Date$humane(animal.creationDate)));
};
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text(_user$project$Pile_Css_Bulma$emsp),
									_1: {
										ctor: '::',
										_0: A2(
											_user$project$Pile_Css_Bulma_Button$smallPrimaryButton,
											'See History',
											{
												click: _elm_lang$core$Maybe$Just(
													_user$project$Animals_Msg$NewHistoryPage(animal))
											}),
										_1: {ctor: '[]'}
									}
								}
...
var _user$project$Animals_Pages_AddPage$startHelp = function (iconType) {
	return A3(
		...
		'fa-question-circle',
		'Help for this form',
		_user$project$Animals_Msg$SetOverlay(_user$project$Animals_Types_ModalOverlay$AddAnimalsHelp));
};
	...
	return _user$project$Pile_Css_Bulma$centeredLevelItem(
		{
			...
			_1: {
				...
				_0: A3(
					...
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'bovine', _1: 'bovine'},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'equine', _1: 'equine'},
							_1: {ctor: '[]'}
						}
					},
					model.speciesToAdd),
...
var _user$project$Animals_Pages_AllPage$withoutArg = _user$project$Animals_Msg$OnAllPage;
var _user$project$Animals_Pages_AllPage$withArg = function (opArg) {
	return function (_p0) {
		return _user$project$Animals_Msg$OnAllPage(
			opArg(_p0));
	};
...
var _user$project$Animals_Pages_AllPage$filterHelp = function (iconType) {
	return A3(
		...
		'fa-question-circle',
		'Help on filtering',
		_user$project$Animals_Msg$SetOverlay(_user$project$Animals_Types_ModalOverlay$AllPageFilterByHelp));
};
var _user$project$Animals_Pages_AllPage$calendarHelp = function (iconType) {
	return A3(
		iconType,
		'fa-question-circle',
		'Help on animals and dates',
		_user$project$Animals_Msg$SetOverlay(_user$project$Animals_Types_ModalOverlay$AllPageCalendarHelp));
};
	...
	return _user$project$Pile_Css_Bulma$centeredLevelItem(
		{
			...
			_1: {
				...
				_0: A3(
					...
					function (_p1) {
						return _user$project$Animals_Msg$OnAllPage(
							_user$project$Animals_Msg$SetSpeciesFilter(_p1));
					},
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: ' ', _1: 'Any'},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'bovine', _1: 'bovine'},
							_1: {
...
var _user$project$Animals_Pages_AllPage$tagsFilter = function (model) {
	return _user$project$Pile_Css_Bulma$centeredLevelItem(
		{
			ctor: '::',
			_0: _user$project$Pile_Css_Bulma$headingP('Tag'),
			_1: {
				ctor: '::',
				_0: A2(
					_user$project$Pile_Css_Bulma$simpleTextInput,
					model.tagFilter,
					_user$project$Animals_Pages_AllPage$withArg(_user$project$Animals_Msg$SetTagFilter)),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Animals_Pages_AllPage$nameFilter = function (model) {
	return _user$project$Pile_Css_Bulma$centeredLevelItem(
		{
			ctor: '::',
			_0: _user$project$Pile_Css_Bulma$headingP('Name'),
			_1: {
				ctor: '::',
				_0: A2(
					_user$project$Pile_Css_Bulma$simpleTextInput,
					model.nameFilter,
					_user$project$Animals_Pages_AllPage$withArg(_user$project$Animals_Msg$SetNameFilter)),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Animals_Pages_AllPage$dateControl = F3(
	function (hasOpenPicker, displayString, calendarToggleMsg) {
		var iconF = function () {
			var _p2 = hasOpenPicker;
			if (_p2 === false) {
				return A2(_user$project$Pile_Css_Bulma$plainIcon, 'fa-caret-down', 'Pick a date from a calendar');
			} else {
				return A2(_user$project$Pile_Css_Bulma$plainIcon, 'fa-caret-up', 'Close the calendar');
			}
		}();
		return A2(
			_elm_lang$html$Html$p,
...
var _user$project$Animals_Pages_AllPage$displaySortKey = function (displayed) {
	var _p4 = displayed.view;
	if (_p4.ctor === 'Writable') {
		return _p4._0.sortKey;
	} else {
		return _p4._0.name;
	}
};
var _user$project$Animals_Pages_AllPage$applyFilters = F2(
	function (model, xs) {
		var rightTag = function (_p5) {
			return A2(
				_user$project$Pile_Namelike$isTagListAllowed,
				model.tagFilter,
				_user$project$Animals_Types_Lenses$displayed_tags.get(_p5));
		};
		var rightName = function (_p6) {
			return A2(
				_user$project$Pile_Namelike$isPrefix,
				model.nameFilter,
				_user$project$Animals_Types_Lenses$displayed_name.get(_p6));
		};
		var rightSpecies = function (_p7) {
			return A2(
				_user$project$Pile_Namelike$isPrefix,
				model.speciesFilter,
				_user$project$Animals_Types_Lenses$displayed_species.get(_p7));
		};
		return A2(
			_user$project$Pile_Namelike$sortByName,
			_user$project$Animals_Pages_AllPage$displaySortKey,
			A2(
				_elm_lang$core$List$filter,
...
var _user$project$Animals_Pages_AllPage$filters = function (model) {
	return {
		ctor: '::',
		_0: A2(
			_user$project$Pile_Css_Bulma$messageView,
			{
				...
				_1: {
					ctor: '::',
					_0: _user$project$Animals_Pages_AllPage$filterHelp(_user$project$Pile_Css_Bulma$rightIcon),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _user$project$Animals_Pages_AllPage$effectiveDate = function (model) {
	var specialistButton = _user$project$Pile_Css_Bulma_Button$rawButton('button is-primary is-small pull-right');
	return {
		ctor: '::',
		_0: A2(
			_user$project$Pile_Css_Bulma$messageView,
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Show animals as of...'),
				_1: {
					ctor: '::',
					_0: _user$project$Animals_Pages_AllPage$calendarHelp(_user$project$Pile_Css_Bulma$rightIcon),
					_1: {ctor: '[]'}
				}
			},
			{
					...
					},
					{
						...
						_0: A2(
							...
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									_user$project$Pile_DateHolder$enhancedDateString(model.effectiveDate)),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
...
var _user$project$Animals_Pages_AllPage$animalViews = function (model) {
	var animalViewer = A2(
		_user$project$Animals_Pages_Common$individualAnimalView,
		model,
		{ctor: '_Tuple2', _0: _user$project$Animals_Msg$StartSavingEdits, _1: _user$project$Animals_Msg$CancelEdits});
	var displayed = A2(
		_user$project$Animals_Pages_Common$pageAnimals,
		function (_) {
			return _.allPageAnimals;
	...
	return A2(
		_elm_lang$core$List$map,
		animalViewer,
		A2(_user$project$Animals_Pages_AllPage$applyFilters, model, displayed));
};
var _user$project$Animals_Pages_AllPage$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Pile_Css_Bulma$centeredColumns(
				{
					ctor: '::',
					_0: A2(
						_user$project$Pile_Css_Bulma$column,
						3,
						_user$project$Animals_Pages_AllPage$effectiveDate(model)),
					_1: {
						ctor: '::',
						_0: A2(
							_user$project$Pile_Css_Bulma$column,
							8,
							_user$project$Animals_Pages_AllPage$filters(model)),
						_1: {ctor: '[]'}
					}
				}),
			_1: {
...
var _user$project$Animals_Pages_HelpPage$view = function (model) {
	return _user$project$Pile_Css_Bulma$plainMessage(
		{
			ctor: '::',
			_0: _user$project$Pile_Css_Bulma$contentP(
				{
					ctor: '::',
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('An animal has a '),
											_1: {
												ctor: '::',
												_0: A2(
													_elm_lang$html$Html$i,
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('species'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html$text('. That never changes.'),
													_1: {ctor: '[]'}
												}
											}
										}),
										...
										_0: A2(
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('An animal has '),
														_1: {
															ctor: '::',
															_0: A2(
																_elm_lang$html$Html$i,
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html$text('. Those are just words. They can be used when working with\n                         animals. For example, when working with horses, you might\n                         want to look only at mares.\n                         '),
																_1: {ctor: '[]'}
															}
														}
													}),
											...
											_0: A2(
												...
												{ctor: '[]'},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('An animal can also have '),
															_1: {
																ctor: '::',
																_0: A2(
																	_elm_lang$html$Html$i,
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text('properties'),
																		_1: {ctor: '[]'}
																	}),
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('. Whereas tags either apply or not - and that\'s it -\n                        properties both apply and have \n                        '),
																	_1: {
																		ctor: '::',
																		_0: A2(
																			_elm_lang$html$Html$i,
...
var _user$project$Animals_Pages_HistoryPage$updateWarning = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		...
		_0: A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('This page does not update'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}),
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('If you now change this animal on the '),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$a,
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text(' page, those changes won\'t show up here. You\'ll need to click the animal\'s '),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$a,
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('See History'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html$text(' button to refresh this page. (Todo: fix this.)'),
											_1: {ctor: '[]'}
										}
									}
								}
...
var _user$project$Animals_Pages_HistoryPage$historyRow = function (entry) {
	var audit = _elm_lang$html$Html$text(
		A2(
			_elm_lang$core$Basics_ops['++'],
			'by ',
			A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					' on ',
					_user$project$Pile_Date$humane(entry.audit.date)))));
	var date = _elm_lang$html$Html$text(
		_user$project$Pile_Date$humane(entry.effectiveDate));
	var dash = A2(
		...
		{ctor: '[]'});
	var stringChange = function (maybeString) {
		var _p0 = maybeString;
		if (_p0.ctor === 'Nothing') {
			return dash;
		} else {
	...
	var name = stringChange(entry.nameChange);
	var listChange = function (changes) {
		var _p1 = _elm_lang$core$List$isEmpty(changes);
		if (_p1 === true) {
			return dash;
		} else {
			return _elm_lang$html$Html$text(
				A2(_elm_lang$core$String$join, ', ', changes));
		}
	};
	var newTags = listChange(entry.newTags);
	var deletedTags = listChange(entry.deletedTags);
	return A2(
		_elm_lang$html$Html$tr,
		{ctor: '[]'},
		{
...
var _user$project$Animals_Pages_HistoryPage$historyTable = function (history) {
	return A2(
		_elm_lang$html$Html$table,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('table is-striped is-narrow'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
							...
							_1: {
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('New tags'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Removed tags'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Audit Trail'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$tbody,
					{ctor: '[]'},
					A2(_elm_lang$core$List$map, _user$project$Animals_Pages_HistoryPage$historyRow, history.entries)),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Animals_Pages_HistoryPage$pageCloseButton = function (id) {
	return A2(
		_elm_lang$html$Html$a,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Close tab'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _user$project$Animals_Pages_HistoryPage$pageHelp = function (iconType) {
	return A3(
		iconType,
		'fa-question-circle',
		'Help for this page',
		_user$project$Animals_Msg$SetOverlay(_user$project$Animals_Types_ModalOverlay$AnimalHistoryHelp));
};
var _user$project$Animals_Pages_HistoryPage$unimplemented = {
	click: _elm_lang$core$Maybe$Just(
		_user$project$Animals_Msg$SetOverlay(_user$project$Animals_Types_ModalOverlay$Unimplemented))
};
var _user$project$Animals_Pages_HistoryPage$controls = function (id) {
	return _user$project$Pile_Css_Bulma$centeredColumns(
		{
			ctor: '::',
			_0: A2(
				...
				11,
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('What next?'),
							_1: {
								ctor: '::',
								_0: _user$project$Animals_Pages_HistoryPage$pageHelp(_user$project$Pile_Css_Bulma$rightIcon),
								_1: {ctor: '[]'}
							}
						},
						{
							...
							_0: _user$project$Pile_Css_Bulma$distributeHorizontally(
								{
									ctor: '::',
									_0: A2(_user$project$Pile_Css_Bulma_Button$primaryButton, 'Export for spreadsheet', _user$project$Animals_Pages_HistoryPage$unimplemented),
									_1: {
										ctor: '::',
										_0: A2(_user$project$Pile_Css_Bulma_Button$primaryButton, 'PDF report', _user$project$Animals_Pages_HistoryPage$unimplemented),
										_1: {
											ctor: '::',
											_0: _user$project$Animals_Pages_HistoryPage$pageCloseButton(id),
											_1: {ctor: '[]'}
										}
									}
								}),
					...
					_0: A2(
						...
						},
						{
							...
							_0: _user$project$Pile_Css_Bulma$contentP(
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('In this stage of development, there\'s a technical \n                        limitation that breaks certain ways of \"returning\"\n                        to an animal\'s history.\n                        '),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: _user$project$Pile_Css_Bulma$contentP(
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Sorry about that.'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
...
var _user$project$Pile_Css_Bulma_Modal$cancel = function (msg) {
	return A2(
		_elm_lang$html$Html$p,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('button pull-right'),
					_1: {
						ctor: '::',
						_0: _user$project$Pile_HtmlShorthand$onClickPreventingDefault(msg),
						_1: {ctor: '[]'}
...
var _user$project$Pile_Css_Bulma_Modal$save = function (msg) {
	return A2(
		_elm_lang$html$Html$a,
		{
			ctor: '::',
...
var _user$project$Pile_Css_Bulma_Modal$saveCancelModal = F4(
...
var _user$project$Pile_Css_Bulma_Modal$dismissableModal = F3(
	function (title, body, dismissMsg) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
			...
			},
			{
				...
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_1: {
							ctor: '::',
							_0: _user$project$Pile_HtmlShorthand$onClickPreventingDefault(dismissMsg),
							_1: {ctor: '[]'}
						}
					},
					{ctor: '[]'}),
						...
						},
						{
							...
							_0: A2(
								...
								},
								{
									...
									_1: {
										ctor: '::',
										_0: _user$project$Pile_Css_Bulma_Modal$xCancel(dismissMsg),
										_1: {ctor: '[]'}
									}
								}),
							_1: {
...
var _user$project$Animals_View_Overlay$help = F2(
	function (title, body) {
		return _elm_lang$core$Maybe$Just(
			A3(
				_user$project$Pile_Css_Bulma_Modal$dismissableModal,
				title,
				body,
				_user$project$Animals_Msg$SetOverlay(_user$project$Animals_Types_ModalOverlay$None)));
	});
var _user$project$Animals_View_Overlay$allPageCalendarHelp = function (model) {
	return A2(
		_user$project$Animals_View_Overlay$help,
		'About the Effective Date',
		{
			...
			_0: _user$project$Pile_Css_Bulma$contentP(
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('The View Animals page shows animals as of a particular day, called the '),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$i,
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html$text('. If you '),
							_1: {
								ctor: '::',
								_0: _user$project$Pile_Css_Bulma_Button$helpTextPrimaryButton('Change'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text(' the effective date back to before a particular animal was\n                added, that animal won\'t appear in the list.\n                '),
									_1: {ctor: '[]'}
								}
							}
						}
			...
			_1: {
				...
				_0: _user$project$Pile_Css_Bulma$contentP(
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('You can edit an animal by clicking on the pencil icon '),
						_1: {
							ctor: '::',
							_0: _user$project$Pile_Css_Bulma$helpTextIcon('fa-pencil'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html$text(' . If you haven\'t changed the effective date, the change\n                takes place today. But you can make a change retroactive by\n                changing the effective date to the past, or you can schedule\n                it for the future by changing the effective date to the future.\n                '),
								_1: {ctor: '[]'}
							}
						}
					}),
...
var _user$project$Animals_View_Overlay$allPageFilterByHelp = function (model) {
	return A2(
		_user$project$Animals_View_Overlay$help,
		'About Filtering Animals',
		{
			ctor: '::',
			_0: _user$project$Pile_Css_Bulma$contentP(
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('You can reduce the number of animals shown on the page with\n               these three filters.\n               '),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
						...
						_0: _user$project$Pile_Css_Bulma$contentP(
							{
								...
								_1: {
									ctor: '::',
									_0: _user$project$Pile_Css_Bulma$readOnlyTag('skittish'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text(' and one tagged '),
										_1: {
											ctor: '::',
											_0: _user$project$Pile_Css_Bulma$readOnlyTag('stallion'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html$text('. If you then add a \"k\", only the first animal will remain.\n               '),
												_1: {ctor: '[]'}
											}
										}
									}
...
var _user$project$Animals_View_Overlay$formHelp = function (model) {
	return A2(
		_user$project$Animals_View_Overlay$help,
		'About Editing Animals',
		{
			ctor: '::',
			_0: _user$project$Pile_Css_Bulma$contentP(
				{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$href('mailto:marick@exampler.com'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html$text(' what questions you have that should be answered here.'),
							_1: {ctor: '[]'}
						}
					}
				}),
...
var _user$project$Animals_View_Overlay$addAnimalsHelp = function (model) {
	return A2(
		_user$project$Animals_View_Overlay$help,
		'About Adding Animals',
		{
			...
			_0: _user$project$Pile_Css_Bulma$contentP(
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('The simplest way to add an animal is to select its species, then click '),
					_1: {
						ctor: '::',
						_0: _user$project$Pile_Css_Bulma_Button$helpTextPrimaryButton('Click to add more information'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html$text('. You must then add a name. Optionally, you can add tags.\n               (Later, you\'ll be able to add more than just tags.)\n               '),
							_1: {ctor: '[]'}
						}
					}
				}),
			_1: {
				...
				_0: _user$project$Pile_Css_Bulma$contentP(
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('By default, the animal will be created effective immediately.\n               You can change the creation date with the \n               '),
						_1: {
							ctor: '::',
							_0: _user$project$Pile_Css_Bulma_Button$helpTextPrimaryButton('Change date'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html$text(' button. You\'re allowed to create animals in the past.'),
								_1: {ctor: '[]'}
							}
						}
					}),
				_1: {
					...
					_0: _user$project$Pile_Css_Bulma$contentP(
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('You\'ll often want to add several similar animals at once,\n              perhaps five horses. \n              You can avoid having to re-enter the same information several times.\n              Like this:\n              '),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$ol,
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Pick the desired species and click '),
												_1: {
													ctor: '::',
													_0: _user$project$Pile_Css_Bulma_Button$helpTextPrimaryButton('Click to add more information'),
													_1: {
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Add the information common to all or most of the animals.\n                   For example, you might add the tag \"mare\" and set the\n                   creation date to next week.\n                   '),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: A2(
													...
													{ctor: '[]'},
													{
														...
														_1: {
															ctor: '::',
															_0: _user$project$Pile_Css_Bulma$helpTextIcon('fa-plus'),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html$text(' (copy) icon on the right side of the form, and create four copies. '),
																_1: {ctor: '[]'}
															}
														}
													}),
...
var _user$project$Animals_View_Overlay$animalHistoryHelp = function (model) {
	return A2(
		_user$project$Animals_View_Overlay$help,
		'About Animal History',
		{
			ctor: '::',
			_0: _user$project$Pile_Css_Bulma$contentP(
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('This page is only a sketch of how one kind of reporting will work.\n                It shows that you\'ll be able to observe not only how animals\n                have changed over time, but who made the changes and when.\n                '),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				...
				_1: {
					...
					_0: _user$project$Pile_Css_Bulma$contentP(
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('However, in this sort of application, it\'s almost always the case\n                that \n                '),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$i,
...
var _user$project$Animals_View_Overlay$unimplemented = function (model) {
	return A2(
		_user$project$Animals_View_Overlay$help,
		'That Feature Isn\'t Implemented Yet',
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(' The button is only there to suggest the sorts of things this app\n            will eventually do.\n            '),
			_1: {ctor: '[]'}
		});
};
var _user$project$Animals_View_Overlay$calendarWarning = A2(
	_elm_lang$html$Html$p,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('icon is-danger'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
		...
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html$text(' Note: Changing the date will reload the animals.\n            If you are in the middle of editing any animals, those changes\n            will be lost. (Todo: Only show this message when animals are being\n            edited.)\n            '),
			_1: {ctor: '[]'}
		}
	});
var _user$project$Animals_View_Overlay$viewCalendar = function (model) {
	var body = {
		ctor: '::',
		_0: _user$project$Animals_View_Overlay$calendarWarning,
		_1: {
			ctor: '::',
			_0: A2(
				_user$project$Pile_Calendar$view,
	...
	return _elm_lang$core$Maybe$Just(
		A4(
			_user$project$Pile_Css_Bulma_Modal$saveCancelModal,
			'Change the Date',
			body,
...
var _user$project$Animals_View_Overlay$view = function (model) {
	var _p1 = model.overlay;
	switch (_p1.ctor) {
		case 'None':
			return _elm_lang$core$Maybe$Nothing;
		case 'AllPageCalendar':
			return _user$project$Animals_View_Overlay$viewCalendar(model);
		case 'AllPageCalendarHelp':
			return _user$project$Animals_View_Overlay$allPageCalendarHelp(model);
		case 'AllPageFilterByHelp':
			return _user$project$Animals_View_Overlay$allPageFilterByHelp(model);
		case 'AddAnimalsHelp':
			return _user$project$Animals_View_Overlay$addAnimalsHelp(model);
		case 'AnimalHistoryHelp':
			return _user$project$Animals_View_Overlay$animalHistoryHelp(model);
		case 'FormHelp':
			return _user$project$Animals_View_Overlay$formHelp(model);
		default:
			return _user$project$Animals_View_Overlay$unimplemented(model);
	}
};

var _user$project$Animals_View$page = function (model) {
	var _p0 = model.page;
	switch (_p0.ctor) {
		case 'AllPage':
		...
		default:
			return A2(_user$project$Animals_Pages_HistoryPage$view, _p0._0, model);
	}
};
var _user$project$Animals_View$historyPages = function (model) {
	return A2(
		_elm_lang$core$List$map,
		function (history) {
			return {
				ctor: '_Tuple3',
				_0: _user$project$Animals_Pages_H$HistoryPage(history.id),
				_1: history.name,
				_2: _user$project$Animals_Pages_Navigation$gotoMsg(
					_user$project$Animals_Pages_H$HistoryPage(history.id))
			};
		},
		_elm_community$maybe_extra$Maybe_Extra$values(
			A2(
				_elm_lang$core$List$map,
				A2(_elm_lang$core$Basics$flip, _elm_lang$core$Dict$get, model.historyPages),
				model.historyOrder)));
};
var _user$project$Animals_View$tabs = function (model) {
	return A2(
		_user$project$Pile_Css_Bulma$tabs,
		model.page,
		A2(
			_elm_lang$core$Basics_ops['++'],
			{
				...
				_0: {
					...
					_1: 'View Animals',
					_2: _user$project$Animals_Pages_Navigation$gotoMsg(_user$project$Animals_Pages_H$AllPage)
				},
				_1: {
					ctor: '::',
					_0: {
						...
						_1: 'Add Animals',
						_2: _user$project$Animals_Pages_Navigation$gotoMsg(_user$project$Animals_Pages_H$AddPage)
					},
					_1: {
						ctor: '::',
						_0: {
							...
							_1: 'About Animals',
							_2: _user$project$Animals_Pages_Navigation$gotoMsg(_user$project$Animals_Pages_H$HelpPage)
						},
						_1: {ctor: '[]'}
					}
				}
			},
			_user$project$Animals_View$historyPages(model)));
};
var _user$project$Animals_View$view = function (model) {
	var parts = {
		ctor: '::',
		_0: _elm_lang$core$Maybe$Just(
			_user$project$Animals_View$tabs(model)),
		_1: {
			ctor: '::',
			_0: _elm_lang$core$Maybe$Just(
				_user$project$Animals_View$page(model)),
			_1: {
				ctor: '::',
				_0: _user$project$Animals_View_Overlay$view(model),
				_1: {ctor: '[]'}
			}
		}
	};
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		_elm_community$maybe_extra$Maybe_Extra$values(parts));
};
...
var _user$project$IV_Version$source = 'https://github.com/marick/eecrit/tree/v895/web/elm/IV';
var _user$project$IV_Version$text = 'Version v895 of 2017-Feb-16';
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Copyright © 2017 Brian Marick'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
