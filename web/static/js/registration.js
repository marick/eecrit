...
var _user$project$Components_AnimalChoiceList$decodeAnimalChoiceData = A3(
	_elm_lang$core$Json_Decode$object2,
	_user$project$Components_AnimalChoice$Model,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'name', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'kind', _elm_lang$core$Json_Decode$string));
var _user$project$Components_AnimalChoiceList$decodeAnimalChoiceList = _elm_lang$core$Json_Decode$list(_user$project$Components_AnimalChoiceList$decodeAnimalChoiceData);
var _user$project$Components_AnimalChoiceList$decodeAnimalChoiceFetch = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['data']),
...
var _user$project$Components_AnimalChoiceList$FetchSucceed = function (a) {
...
var _user$project$Components_AnimalChoiceList$fetchAnimalChoiceList = function () {
	...
	return A3(
		...
		_user$project$Components_AnimalChoiceList$FetchSucceed,
		A2(_evancz$elm_http$Http$get, _user$project$Components_AnimalChoiceList$decodeAnimalChoiceFetch, url));
}();
var _user$project$Components_AnimalChoiceList$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'Fetch':
				return {ctor: '_Tuple2', _0: model, _1: _user$project$Components_AnimalChoiceList$fetchAnimalChoiceList};
			case 'FetchSucceed':
				return {
					ctor: '_Tuple2',
...
var Elm = {};
Elm['Registration'] = Elm['Registration'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Registration'], 'Registration', typeof _user$project$Registration$main === 'undefined' ? null : _user$project$Registration$main);
