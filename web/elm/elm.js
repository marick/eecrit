...
var _user$project$Pile_Namelike$validAddition = F2(
	function (candidate, existing) {
		return !A2(_user$project$Pile_Namelike$isMember, candidate, existing);
	});
...
var Elm = {};
Elm['Pile'] = Elm['Pile'] || {};
Elm['Pile']['Namelike'] = Elm['Pile']['Namelike'] || {};
if (typeof _user$project$Pile_Namelike$main !== 'undefined') {
    _user$project$Pile_Namelike$main(Elm['Pile']['Namelike'], 'Pile.Namelike', undefined);
}
